...
public class CGEFrameRecorder extends CGEFrameRenderer {
    ...
    private native boolean nativeStartRecording(long j, int i, String str, int bitRate, int width, int i2);
    ...
    public boolean startRecording(int fps, String filename,int width,int height) {
        return startRecording(fps, 1650000, filename,width,height);
    }

    public boolean startRecording(int fps, int bitRate, String filename,int width,int height) {
        if (this.mNativeAddress != 0) {
            return nativeStartRecording(this.mNativeAddress, fps, filename, bitRate,width,height);
        }
        return false;
    }
