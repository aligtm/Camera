...
import static com.techkiii.Camera.CameraActivity.getRealScreenSize;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private RelativeLayout rvCamera;
...
//        CGENativeLibrary.setLoadImageCallback(this.loadImageCallback, null);
        ...
        initHeightWidth();
        if (VERSION.SDK_INT >= 23 && !(checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0 && checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == 0 && checkSelfPermission("android.permission.CAMERA") == 0 && checkSelfPermission("android.permission.RECORD_AUDIO") == 0)) { permissionDialog(); }
        ...
        rvCamera.setOnClickListener(new OnClickListener(){
            @Override
