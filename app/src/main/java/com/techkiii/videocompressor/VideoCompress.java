package com.techkiii.videocompressor;
...
public class VideoCompress {
    ...
    public static VideoCompressTask compressVideoHigh4K(String srcPath, String destPath, CompressListener listener) {
        VideoCompressTask task = new VideoCompressTask(listener, VideoController.COMPRESS_QUALITY_4K);
        task.execute(srcPath, destPath);
        return task;
    }
